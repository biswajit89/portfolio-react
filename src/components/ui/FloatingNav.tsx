          ...
          <div className="flex items-center gap-0.5 md:gap-1">
            {navItems.map((item, index) => (
              <button
                ...
                className={`group relative flex items-center gap-1 md:gap-2 px-2 md:px-4 py-2 md:py-3 rounded-full transition-all duration-500 transform hover:scale-110 font-mono ${
              ...
              >
                {/* Icon with animation */}
                <div className={`transition-all duration-300 w-4 h-4 md:w-5 md:h-5 ${
